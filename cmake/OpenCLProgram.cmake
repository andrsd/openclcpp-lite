...
function(target_add_opencl_program TARGET)
    ...
    if (NOT IS_ABSOLUTE ${OCLCPPL_FILE})
        set(OCLCPPL_HEADER ${CMAKE_CURRENT_BINARY_DIR}/${OCLCPPL_HEADER})
        set(OCLCPPL_SOURCE ${CMAKE_CURRENT_BINARY_DIR}/${OCLCPPL_SOURCE})
    endif()
